...
Bildinterpretation: Die Bildinterpretation bezieht sich auf die Analyse und Interpretation komplexer Muster in Bildern, abhängig von der Auflösung und Detektierbarkeit des Sensors. Durch additive Farbmischung können Graustufenbilder zu einem RGB-Komposit zusammengesetzt werden.
...
Auf der Webseite Fernerkundung - Marksteine Ihrer Entwicklung gibt es eine ausführliche Tabelle über die Geschichte und Meilensteine der Entwicklung in der Fernerkundung.
...
Reflexion an der Erdoberfläche: Reflexion beschreibt das Zurückwerfen von Strahlung von einer Oberfläche. Man unterscheidet zwischen spiegelnder Reflexion, bei der Strahlung in eine Richtung zurückgeworfen wird, und diffuser Reflexion, bei der Strahlung in verschiedene Richtungen gestreut wird. Die Art der Reflexion hängt von der Beschaffenheit der Oberfläche und der Wellenlänge der Strahlung ab.
...
Kontrastanpassung: Die Kontrastanpassung ist eine Technik zur Verbesserung der Sichtbarkeit von Details und zur Erleichterung der Objekterkennung in Luftaufnahmen. Sie kann durch Anpassung von Helligkeit und Kontrast, Histogrammanpassung oder adaptive Kontrastanpassung erfolgen. Diese Techniken verbessern die Sichtbarkeit und Erkennbarkeit von wichtigen Merkmalen, indem sie den Kontrast gezielt anpassen.

Histogrammanpassung: Die Histogrammanpassung verbessert den Kontrast in einem Bild, indem sie die Verteilung der Pixelwerte im Histogramm anpasst, um den vollen Dynamikbereich der Helligkeit zu nutzen. Dies umfasst die Berechnung des Histogramms, Normalisierung, Berechnung der kumulativen Verteilungsfunktion (CDF) und Histogrammtransformation, um eine bessere Bildqualität und Sichtbarkeit von Details zu erzielen.

Normalized Difference Vegetation Index (NDVI): Der NDVI ist ein Maß für die Menge an lebendiger Vegetation in einem Gebiet und wird aus Fernerkundungsdaten, insbesondere aus Satellitenbildern, abgeleitet. Er basiert auf der Reflexion von Licht im nahen Infrarot (NIR) und im roten Lichtbereich (VIS). Höhere NDVI-Werte deuten auf eine größere Vegetationsbedeckung hin. Der NDVI wird in der Landwirtschaft, Umweltüberwachung, Landnutzungsanalyse und Ökologie verwendet, um den Zustand und die Verteilung der Vegetation zu bewerten.

## 3. Übungen und Leitfäden

**Aufgabenstellung**

Diese Übung soll das Verfahren zur Erzeugung der RGB-Farben veranschaulichen. Wie gezeigt, können die Kanäle eines Sensors ihre eigenen Wellenlängen unterschiedlich stark empfangen. Diese empfangenen Signale können dann durch die additive Farbmischung zu einer RGB-Farbe gemischt werden.

Auf der Webseite Spektrum Colors hat man die Möglichkeit, durch Mischung der Grundfarben verschiedene Farben zu erzeugen. Durch das Einstellen der Regler für die Intensität der einzelnen Farben können mit kleinen Änderungen viele verschiedene Farben erzeugt werden.

Wenn du Inspiration brauchst oder nicht weißt, welche Farbintensitäten du für eine bestimmte Farbe verwenden kannst, findest du auf der Webseite Farbtabelle verschiedene Farbcodes, um eine bestimmte Farbe zu erzeugen.

## 4. Quiz

**Fragen 1**
1.(Multiple Choice) 
* Welche Bereiche der elektromagnetischen Strahlung sind von besonderer Bedeutung für die Fernerkundung?
2. (Ziehe die Wörter in die richtigen Felder)
* ... ist der Transport und die Versorgung sicherzustellen
* ... sind ein Scanner, ein Sensor und Geräte zur Bestimmung von weiteren Daten
3. (Multiple Choice)
* Was versteht man laut DIN 18716 unter einem Scanner?
4. (Ziehe die Wörter in die richtigen Felder)
* ... ein Spektralband, welches das gesamte sichtbare Spektrum erfasst
* ... mehrere Spektralbänder, die jeweils nur eine Wellenlänge erfasst
5. (Multiple Choice)
* Welcher Scanner ähnelt in der Wahrnehmung der Farben dem menschlichen Auge?
6. (Multiple Choice)
* Was versteht man unter dem Begriff „Extinktion“ im Zusammenhang mit der Fernerkundung?
7. (Multiple Choice)
* Warum kann ein Fernerkundungssensor im sichtbaren Bereich nicht durch Wolken hindurchsehen?
8. (Multiple Choice)
* Wie wird Reflexion laut DIN 18716 definiert?
9. (Multiple Choice)
* Welche Aussage trifft auf die Reflexionseigenschaften von Wasseroberflächen zu?
10. (Multiple Choice)
* Welche Eigenschaft weist die spektrale Signatur der Vegetation bei etwa 700 Nanometern auf?
11. (Multiple Choice)
* Warum erscheint klares Wasser im infraroten Spektralbereich schwarz?
12. (Ziehe die Wörter in die richtigen Felder)
* ... Synonym für die Bandbreite im Sensor
* ... Anzahl der Graustufen pro Spektralband
